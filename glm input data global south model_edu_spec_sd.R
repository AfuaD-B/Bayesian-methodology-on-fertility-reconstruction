...
mod_stringedu_global_south = "model {
  for (i in 1:length(period)){
    ...
    for(j in 1:length(Age)){
      ...
      ESASFR_star_1[i,j]~dnorm(ESASFR_dhs_1[i,j],prec_esasfr1)T(0,)
     
      ESASFR_star_2[i,j]~dnorm(ESASFR_dhs_2[i,j],prec_esasfr2)T(0,)
      
      ESASFR_star_3[i,j]~dnorm(ESASFR_dhs_3[i,j],prec_esasfr3)T(0,)
  ...
  sd_asfr_UN=ASFR_UN_sd
  prec_esasfr1~dgamma(s_esasfr1,sesasfr1)
  prec_esasfr2~dgamma(s_esasfr2,sesasfr2)
  prec_esasfr3~dgamma(s_esasfr3,sesasfr3)
  prec_esasfr4~dgamma(s_esasfr4,sesasfr4)
}"
...
jagsdat_global_south$ASFR_UN_sd=(sd(asfr_UN_$Asfr)^2)

jagsdat_global_south$sesasfr1=(sd(dat_global_southedu_se2$`Higher Education`))^2
jagsdat_global_south$sesasfr2=(sd(dat_global_southedu_se2$`No Education`))^2
jagsdat_global_south$sesasfr3=(sd(dat_global_southedu_se2$`Primary Education`))^2
jagsdat_global_south$sesasfr4=(sd(dat_global_southedu_se2$`Secondary Education`))^2


jagsdat_global_south$s_esasfr1=1/((sd(dat_global_southedu_se2$`Higher Education`))^2)
jagsdat_global_south$s_esasfr2=1/((sd(dat_global_southedu_se2$`No Education`))^2)
jagsdat_global_south$s_esasfr3=1/((sd(dat_global_southedu_se2$`Primary Education`))^2)
jagsdat_global_south$s_esasfr4=1/((sd(dat_global_southedu_se2$`Secondary Education`))^2)
...
pdf("K:/project/BayesEdu/Fertility/Afua/All countries Bayesian codes/Sensitivity/ESASFR init vs data qual glmmodel_edu_sec_sd.pdf", width=12,onefile = T)
...
pdf("K:/project/BayesEdu/Fertility/Afua/All countries Bayesian codes/Sensitivity/ESASFR_dhs vs data qual glmmodel_edu_sec_sd.pdf", width=15,height=12,onefile = T)
for (Country_ in seq(length(Country_plots))){
  grid.arrange(Country_plots[[Country_]])  
}
dev.off()
...
pdf("K:/project/BayesEdu/Fertility/Afua/All countries Bayesian codes/Sensitivity/ASFR UN vs data qual glmmodel_edu_sec_sd.pdf",width = 12, onefile = TRUE)
for (Country_ in seq(length(Country_plots))){
  grid.arrange(Country_plots[[Country_]])  
}
dev.off()
...
pdf("K:/project/BayesEdu/Fertility/Afua/All countries Bayesian codes/Sensitivity/TFR data qaul.pdf",width = 12, onefile = TRUE)
...
pdf("K:/project/BayesEdu/Fertility/Afua/All countries Bayesian codes/Sensitivity/ESTFR_dhs vs data qual glmmodel_edu_sec_sd.pdf",width = 12, onefile = TRUE)
...
write_xlsx(list("BESASFR"=bayesdat_global_southesasfr,"BESTFR"=bayesdat_global_southestfr,
           ...
           path ="K:/project/BayesEdu/Fertility/Afua/All countries Bayesian codes/Sensitivity/BESFR_data qaul glmmodel_edu_spec_sd.xlsx", col_names=TRUE)
