...
jagsdat_global_south$s_esasfr1=1/(mean(dat_global_southedu_se2$`Higher Education`))
jagsdat_global_south$s_esasfr2=1/(mean(dat_global_southedu_se2$`No Education`))
jagsdat_global_south$s_esasfr3=1/(mean(dat_global_southedu_se2$`Primary Education`))
jagsdat_global_south$s_esasfr4=1/(mean(dat_global_southedu_se2$`Secondary Education`))
...
pdf("K:/project/BayesEdu/Fertility/Afua/All countries Bayesian codes/Sensitivity/ESASFR init vs data qaul glmmodel_edu_spec_mean.pdf", width=12,onefile = T)
...
pdf("K:/project/BayesEdu/Fertility/Afua/All countries Bayesian codes/Sensitivity/ESASFR_dhs vs data qaul glmmodel_edu_spec_mean.pdf", width=15,height=12,onefile = T)
for (Country_ in seq(length(Country_plots))){
  grid.arrange(Country_plots[[Country_]])  
}
dev.off()
...
pdf("K:/project/BayesEdu/Fertility/Afua/All countries Bayesian codes/Sensitivity/ASFR UN vs data qaul glmmodel_edu_spec_mean.pdf",width = 12, onefile = TRUE)
for (Country_ in seq(length(Country_plots))){
  grid.arrange(Country_plots[[Country_]])  
}
dev.off()
...
pdf("K:/project/BayesEdu/Fertility/Afua/All countries Bayesian codes/Sensitivity/ESTFR_dhs vs data qaul glmmodel_edu_spec_mean.pdf",width = 12, onefile = TRUE)
...
write_xlsx(list("BESASFR"=bayesdat_global_southesasfr,"BESTFR"=bayesdat_global_southestfr,
           ...
           path ="K:/project/BayesEdu/Fertility/Afua/All countries Bayesian codes/Sensitivity/BESFR_data qaul glmmodel_edu_spec_mean.xlsx", col_names=TRUE)
