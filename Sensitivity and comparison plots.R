...
Main_model<-read_excel("K:/project/BayesEdu/Fertility/Afua/All countries Bayesian codes/BESFR_estimates global_south.xlsx",sheet = "BESASFR")
  
model1<-read_excel("K:/project/BayesEdu/Fertility/Afua/All countries Bayesian codes/Sensitivity/BESFR_data qaul glmmodel_se_sd_c_y_a.xlsx",sheet = "BESASFR")

model2<-read_excel("K:/project/BayesEdu/Fertility/Afua/All countries Bayesian codes/Sensitivity/BESFR_data qaul glmmodel_edu_spec_sd.xlsx",sheet = "BESASFR")

model3<-read_excel("K:/project/BayesEdu/Fertility/Afua/All countries Bayesian codes/Sensitivity/BESFR_data qaul glmmodel_edu_spec_mean.xlsx",sheet = "BESASFR")

model4<-read_excel("K:/project/BayesEdu/Fertility/Afua/All countries Bayesian codes/Sensitivity/BESFR_ data qaul model_gamma_47.xlsx",sheet = "BESASFR")

model5<-read_excel("K:/project/BayesEdu/Fertility/Afua/All countries Bayesian codes/Sensitivity/BESFR_data qaul glmmodel_pred_prec.xlsx",sheet = "BESASFR")

model6<-read_excel("K:/project/BayesEdu/Fertility/Afua/All countries Bayesian codes/Sensitivity/BESFR_data qaul glmmodel_alpha_beta.xlsx",sheet = "BESASFR")

model7<-read_excel("K:/project/BayesEdu/Fertility/Afua/All countries Bayesian codes/Sensitivity/BESFR_data qaul glmmodel_se_sd_c_y_e.xlsx",sheet = "BESASFR")
...
pdf("K:/project/BayesEdu/Fertility/Afua/All countries Bayesian codes/Sensitivity/ESASFR_all_model comparison.pdf", width=12,onefile = T)
...
#Read in ASFR data
Main_model_asfr<-read_excel("K:/project/BayesEdu/Fertility/Afua/All countries Bayesian codes/BESFR_estimates global_south.xlsx",sheet = "ASFR")

model1_asfr<-read_excel("K:/project/BayesEdu/Fertility/Afua/All countries Bayesian codes/Sensitivity/BESFR_data qaul glmmodel_se_sd_c_y_a.xlsx",sheet = "ASFR")

model2_asfr<-read_excel("K:/project/BayesEdu/Fertility/Afua/All countries Bayesian codes/Sensitivity/BESFR_data qaul glmmodel_edu_spec_sd.xlsx",sheet = "ASFR")

model3_asfr<-read_excel("K:/project/BayesEdu/Fertility/Afua/All countries Bayesian codes/Sensitivity/BESFR_data qaul glmmodel_edu_spec_mean.xlsx",sheet = "ASFR")

model4_asfr<-read_excel("K:/project/BayesEdu/Fertility/Afua/All countries Bayesian codes/Sensitivity/BESFR_ data qaul model_gamma_47.xlsx",sheet = "ASFR")

model5_asfr<-read_excel("K:/project/BayesEdu/Fertility/Afua/All countries Bayesian codes/Sensitivity/BESFR_data qaul glmmodel_pred_prec.xlsx",sheet = "ASFR")

model6_asfr<-read_excel("K:/project/BayesEdu/Fertility/Afua/All countries Bayesian codes/Sensitivity/BESFR_data qaul glmmodel_alpha_beta.xlsx",sheet = "ASFR")

model7_asfr<-read_excel("K:/project/BayesEdu/Fertility/Afua/All countries Bayesian codes/Sensitivity/BESFR_data qaul glmmodel_se_sd_c_y_e.xlsx",sheet = "ASFR")
...
pdf("K:/project/BayesEdu/Fertility/Afua/All countries Bayesian codes/Sensitivity/UN_ASFR_model_comparison.pdf", width=12,onefile = T)
for (Country_ in seq(length(Country_plots))){
  grid.arrange(Country_plots[[Country_]])  
}
dev.off()
...
Main_model_tfr<-read_excel("K:/project/BayesEdu/Fertility/Afua/All countries Bayesian codes/BESFR_estimates global_south.xlsx",sheet = "TFR")

model1_tfr<-read_excel("K:/project/BayesEdu/Fertility/Afua/All countries Bayesian codes/Sensitivity/BESFR_data qaul glmmodel_se_sd_c_y_a.xlsx",sheet = "TFR")

model2_tfr<-read_excel("K:/project/BayesEdu/Fertility/Afua/All countries Bayesian codes/Sensitivity/BESFR_data qaul glmmodel_edu_spec_sd.xlsx",sheet = "TFR")

model3_tfr<-read_excel("K:/project/BayesEdu/Fertility/Afua/All countries Bayesian codes/Sensitivity/BESFR_data qaul glmmodel_edu_spec_mean.xlsx",sheet = "TFR")

model4_tfr<-read_excel("K:/project/BayesEdu/Fertility/Afua/All countries Bayesian codes/Sensitivity/BESFR_ data qaul model_gamma_47.xlsx",sheet = "TFR")

model5_tfr<-read_excel("K:/project/BayesEdu/Fertility/Afua/All countries Bayesian codes/Sensitivity/BESFR_data qaul glmmodel_pred_prec.xlsx",sheet = "TFR")

model6_tfr<-read_excel("K:/project/BayesEdu/Fertility/Afua/All countries Bayesian codes/Sensitivity/BESFR_data qaul glmmodel_alpha_beta.xlsx",sheet = "TFR")

model7_tfr<-read_excel("K:/project/BayesEdu/Fertility/Afua/All countries Bayesian codes/Sensitivity/BESFR_data qaul glmmodel_se_sd_c_y_e.xlsx",sheet = "TFR")
...
pdf("K:/project/BayesEdu/Fertility/Afua/All countries Bayesian codes/Sensitivity/TFR_UN_model_comparison.pdf",width = 12, onefile = TRUE)
...
Main_model_estfr<-read_excel("K:/project/BayesEdu/Fertility/Afua/All countries Bayesian codes/BESFR_estimates global_south.xlsx",sheet = "BESTFR")%>%
  mutate(Education=factor(Education, levels=c("No Education","Primary Education","Secondary Education","Higher Education")))

model1_estfr<-read_excel("K:/project/BayesEdu/Fertility/Afua/All countries Bayesian codes/Sensitivity/BESFR_data qaul glmmodel_se_sd_c_y_a.xlsx",sheet = "BESTFR")%>%
  mutate(Education=factor(Education, levels=c("No Education","Primary Education","Secondary Education","Higher Education")))

model2_estfr<-read_excel("K:/project/BayesEdu/Fertility/Afua/All countries Bayesian codes/Sensitivity/BESFR_data qaul glmmodel_edu_spec_sd.xlsx",sheet = "BESTFR")%>%
  mutate(Education=factor(Education, levels=c("No Education","Primary Education","Secondary Education","Higher Education")))

model3_estfr<-read_excel("K:/project/BayesEdu/Fertility/Afua/All countries Bayesian codes/Sensitivity/BESFR_data qaul glmmodel_edu_spec_mean.xlsx",sheet = "BESTFR")%>%
  mutate(Education=factor(Education, levels=c("No Education","Primary Education","Secondary Education","Higher Education")))

model4_estfr<-read_excel("K:/project/BayesEdu/Fertility/Afua/All countries Bayesian codes/Sensitivity/BESFR_ data qaul model_gamma_47.xlsx",sheet = "BESTFR")%>%
  mutate(Education=factor(Education, levels=c("No Education","Primary Education","Secondary Education","Higher Education")))

model5_estfr<-read_excel("K:/project/BayesEdu/Fertility/Afua/All countries Bayesian codes/Sensitivity/BESFR_data qaul glmmodel_pred_prec.xlsx",sheet = "BESTFR")%>%
  mutate(Education=factor(Education, levels=c("No Education","Primary Education","Secondary Education","Higher Education")))

model6_estfr<-read_excel("K:/project/BayesEdu/Fertility/Afua/All countries Bayesian codes/Sensitivity/BESFR_data qaul glmmodel_alpha_beta.xlsx",sheet = "BESTFR")%>%
  mutate(Education=factor(Education, levels=c("No Education","Primary Education","Secondary Education","Higher Education")))

model7_estfr<-read_excel("K:/project/BayesEdu/Fertility/Afua/All countries Bayesian codes/Sensitivity/BESFR_data qaul glmmodel_se_sd_c_y_e.xlsx",sheet = "BESTFR")%>%
  mutate(Education=factor(Education, levels=c("No Education","Primary Education","Secondary Education","Higher Education")))




pdf("K:/project/BayesEdu/Fertility/Afua/All countries Bayesian codes/Sensitivity/ESTFR_all_model comparison.pdf",width = 12, onefile = TRUE)
...
cleaned_DHS_ASFR<-read_excel("K:/project/BayesEdu/Fertility/Afua/All countries Bayesian codes/GLM regional/glm_predict_all_reg3.xlsx",sheet="ASFR_5")
...
cleaned_DHS_ESASFR<-read_excel("K:/project/BayesEdu/Fertility/Afua/All countries Bayesian codes/GLM regional/glm_predict_all_reg3.xlsx",sheet="ESASFR_5")
...
png("K:/project/BayesEdu/Fertility/Afua/All countries Bayesian codes/Sensitivity/ASFR all_model comparison.png",width=2850, height=1850,res=150)
...
png("K:/project/BayesEdu/Fertility/Afua/All countries Bayesian codes/Sensitivity/ESASFR all_model comparison.png",width=4850, height=3550,res=150)
...
png("K:/project/BayesEdu/Fertility/Afua/All countries Bayesian codes/Sensitivity/UN DHS.png",width=2850, height=1550)
...
png("K:/project/BayesEdu/Fertility/Afua/All countries Bayesian codes/Sensitivity/UN DHS ASFR all_model comparison.png",width=2850, height=1550)
