...
modedu_global_south_na1 = jags.model(textConnection(mod_stringedu_global_south_na), data=jagsdat_global_south,n.chains = 3)
update(modedu_global_south_na1,2e4)
...
pdf("./NA_0.05_ASFR.pdf",width = 12, onefile = TRUE)
...
pdf("./NA_0.05_ASFR_DHS.pdf",width = 12, onefile = TRUE)
for (Country_ in seq(length(Country_plots))){
  grid.arrange(Country_plots[[Country_]])  
}
dev.off()
...
modedu_global_south_na2 = jags.model(textConnection(mod_stringedu_global_south_na), data=jagsdat_global_south,n.chains = 3)
update(modedu_global_south_na2, 2e4)
...
pdf("./NA_0.10_ASFR.pdf",width = 12, onefile = TRUE)
for (Country_ in seq(length(Country_plots))){
  grid.arrange(Country_plots[[Country_]])  
}
dev.off()
...
pdf("./NA_0.10_ASFR_DHS.pdf",width = 12, onefile = TRUE)
for (Country_ in seq(length(Country_plots))){
  grid.arrange(Country_plots[[Country_]])  
}
dev.off()
...
modedu_global_south_na3 = jags.model(textConnection(mod_stringedu_global_south_na), data=jagsdat_global_south,n.chains = 3)
update(modedu_global_south_na3, 2e4)
...
pdf("./NA_0.15_ASFR.pdf",width = 12, onefile = TRUE)
for (Country_ in seq(length(Country_plots))){
  grid.arrange(Country_plots[[Country_]])  
}
dev.off()
...
pdf("./NA_0.15_ASFR_DHS.pdf",width = 12, onefile = TRUE)
for (Country_ in seq(length(Country_plots))){
  grid.arrange(Country_plots[[Country_]])  
}
dev.off()
...
modedu_global_south_na4 = jags.model(textConnection(mod_stringedu_global_south_na), data=jagsdat_global_south,n.chains = 3)
update(modedu_global_south_na4, 2e4)
...
pdf("./NA_0.2_ASFR.pdf",width = 12, onefile = TRUE)
for (Country_ in seq(length(Country_plots))){
  grid.arrange(Country_plots[[Country_]])  
}
dev.off()
...
pdf("./NA_0.2_ASFR_DHS.pdf",width = 12, onefile = TRUE)
for (Country_ in seq(length(Country_plots))){
  grid.arrange(Country_plots[[Country_]])  
}
dev.off()
...
modedu_global_south_na5 = jags.model(textConnection(mod_stringedu_global_south_na), data=jagsdat_global_south,n.chains = 3)
update(modedu_global_south_na5, 2e4)
...
pdf("./NA_0.30_ASFR.pdf",width = 12, onefile = TRUE)
for (Country_ in seq(length(Country_plots))){
  grid.arrange(Country_plots[[Country_]])  
}
dev.off()
...
pdf("./NA_0.30_ASFR_DHS.pdf",width = 12, onefile = TRUE)
for (Country_ in seq(length(Country_plots))){
  grid.arrange(Country_plots[[Country_]])  
}
dev.off()
...
pdf("./NA ASFR model comparison.pdf",width = 12,height=28, onefile = TRUE)
...
pdf("./DHS vs UN.pdf",width = 12, onefile = TRUE)
for (Country_ in seq(length(Country_plots))){
  grid.arrange(Country_plots[[Country_]])  
}
dev.off()
...
pdf("./NAs UN.pdf",width = 12, onefile = TRUE)
for (Country_ in seq(length(Country_plots))){
  grid.arrange(Country_plots[[Country_]])  
}
dev.off()
