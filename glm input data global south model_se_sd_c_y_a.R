...
mod_stringedu_global_south = "model {
  for (i in 1:length(period)){
    ...
    for(j in 1:length(Age)){
      ...
      ESASFR_star_1[i,j]~dnorm(ESASFR_dhs_1[i,j],prec_esasfr[i,j])T(0,)
      ESASFR_star_2[i,j]~dnorm(ESASFR_dhs_2[i,j],prec_esasfr[i,j])T(0,)
      ESASFR_star_3[i,j]~dnorm(ESASFR_dhs_3[i,j],prec_esasfr[i,j])T(0,)
      ESASFR_star_4[i,j]~dnorm(ESASFR_dhs_4[i,j],prec_esasfr[i,j])T(0,)
      
      
      ESASFR_old_1[i,j]~dnorm(ESASFR_dhs_1[i,j],prec_esasfr[i,j])T(0,)
      ESASFR_old_2[i,j]~dnorm(ESASFR_dhs_2[i,j],prec_esasfr[i,j])T(0,)
      ESASFR_old_3[i,j]~dnorm(ESASFR_dhs_3[i,j],prec_esasfr[i,j])T(0,)
      ESASFR_old_4[i,j]~dnorm(ESASFR_dhs_4[i,j],prec_esasfr[i,j])T(0,)
      ...
      prec_prec[i,j]=1/prec_esasfr[i,j]  
      prec_esasfr[i,j]~dgamma(inv_var_esasfr[i,j],varsasfr[i,j])
...
dat_global_southeduse2_1<-dat_global_southedu_se2%>%
  mutate(var_sd=rowSds(as.matrix(dat_global_southedu_se2[,4:7])))
dat_global_southeduse2_1<-dat_global_southeduse2_1[,c(1:3,8)]
dat_global_southeduse2_1<-dat_global_southeduse2_1[order(dat_global_southeduse2_1$Country), ]


dat_global_southeduse2_2<-dat_global_southeduse2_1%>%spread(`Age Group`,var_sd)
...
jagsdat_global_south$Age=as.matrix(rbind(dat_global_southedu2_1[1,3:9]))
...
jagsdat_global_south$varsasfr=as.matrix((dat_global_southeduse2_2[,3:9])^2)


jagsdat_global_south$inv_var_esasfr=as.matrix(1/((dat_global_southeduse2_2[,3:9])^2))
...
pdf("K:/project/BayesEdu/Fertility/Afua/All countries Bayesian codes/Sensitivity/ESASFR init vs data qual glmmodel_se_sd_c_y_a.pdf", width=12,onefile = T)
...
pdf("K:/project/BayesEdu/Fertility/Afua/All countries Bayesian codes/Sensitivity/ESASFR_dhs vs data qual glmmodel_se_sd_c_y_a.pdf", width=15,height=12,onefile = T)
for (Country_ in seq(length(Country_plots))){
  grid.arrange(Country_plots[[Country_]])  
}
dev.off()
...
pdf("K:/project/BayesEdu/Fertility/Afua/All countries Bayesian codes/Sensitivity/ASFR UN vs data qual glmmodel_se_sd_c_y_a.pdf",width = 12, onefile = TRUE)
for (Country_ in seq(length(Country_plots))){
  grid.arrange(Country_plots[[Country_]])  
}
dev.off()
...
pdf("K:/project/BayesEdu/Fertility/Afua/All countries Bayesian codes/Sensitivity/TFR data qaul glmmodel_se_sd_c_y_a.pdf",width = 12, onefile = TRUE)
...
pdf("K:/project/BayesEdu/Fertility/Afua/All countries Bayesian codes/Sensitivity/ESTFR_dhs vs data qual glmmodel_se_sd_c_y_a.pdf",width = 12, onefile = TRUE)
...
write_xlsx(list("BESASFR"=bayesdat_global_southesasfr,"BESTFR"=bayesdat_global_southestfr,
           ...
           path ="K:/project/BayesEdu/Fertility/Afua/All countries Bayesian codes/Sensitivity/BESFR_data qaul glmmodel_se_sd_c_y_a.xlsx", col_names=TRUE)
