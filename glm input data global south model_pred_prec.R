...
pdf("./All countries Bayesian codes/Sensitivity/ESASFR init vs data qaul glmmodel_pred_prec.pdf", width=12,onefile = T)
...
pdf("./All countries Bayesian codes/Sensitivity/ESASFR_dhs vs data qaul glmmodel_pred_prec.pdf", width=15,height=12,onefile = T)
for (Country_ in seq(length(Country_plots))){
  grid.arrange(Country_plots[[Country_]])  
}
dev.off()
...
pdf("./All countries Bayesian codes/Sensitivity/ASFR UN vs data qaul glmmodel_pred_prec.pdf",width = 12, onefile = TRUE)
for (Country_ in seq(length(Country_plots))){
  grid.arrange(Country_plots[[Country_]])  
}
dev.off()
...
pdf("./All countries Bayesian codes/Sensitivity/ESTFR_dhs vs data qaul glmmodel_pred_prec.pdf",width = 12, onefile = TRUE)
...
write_xlsx(list("BESASFR"=bayesdat_global_southesasfr,"BESTFR"=bayesdat_global_southestfr,
           ...
           path ="./All countries Bayesian codes/Sensitivity/BESFR_data qaul glmmodel_pred_prec.xlsx", col_names=TRUE)
