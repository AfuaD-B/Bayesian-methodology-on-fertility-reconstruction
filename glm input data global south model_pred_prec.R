...
mod_stringedu_global_south = "model {
  ...
  sd_asfr_UN=ASFR_UN_var
  prec_esasfr~dgamma(s_esasfr,sesasfr)
...
jagsdat_global_south$sesasfr=(sd(dat_global_southedu2_$Pred))^2

jagsdat_global_south$s_esasfr=1/(sd(dat_global_southedu2_$Pred))^2
...
pdf("K:/project/BayesEdu/Fertility/Afua/All countries Bayesian codes/Sensitivity/ESASFR init vs data qaul glmmodel_pred_prec.pdf", width=12,onefile = T)
...
pdf("K:/project/BayesEdu/Fertility/Afua/All countries Bayesian codes/Sensitivity/ESASFR_dhs vs data qaul glmmodel_pred_prec.pdf", width=15,height=12,onefile = T)
for (Country_ in seq(length(Country_plots))){
  grid.arrange(Country_plots[[Country_]])  
}
dev.off()
...
pdf("K:/project/BayesEdu/Fertility/Afua/All countries Bayesian codes/Sensitivity/ASFR UN vs data qaul glmmodel_pred_prec.pdf",width = 12, onefile = TRUE)
for (Country_ in seq(length(Country_plots))){
  grid.arrange(Country_plots[[Country_]])  
}
dev.off()
...
pdf("K:/project/BayesEdu/Fertility/Afua/All countries Bayesian codes/Sensitivity/ESTFR_dhs vs data qaul glmmodel_pred_prec.pdf",width = 12, onefile = TRUE)
...
write_xlsx(list("BESASFR"=bayesdat_global_southesasfr,"BESTFR"=bayesdat_global_southestfr,
           ...
           path ="K:/project/BayesEdu/Fertility/Afua/All countries Bayesian codes/Sensitivity/BESFR_data qaul glmmodel_pred_prec.xlsx", col_names=TRUE)
